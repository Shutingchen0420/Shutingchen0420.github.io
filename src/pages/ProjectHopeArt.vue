<template>
    <v-container>
        ...
        <section id="intro" class="mb-8">
            ...
            <v-row dense>
                <v-col cols="12" md="7">
                    <h1 class="text-h4 font-weight-bold mb-2">HOPE Art Studio 官網</h1>
        ...
        <section id="strategy" class="mb-10">
            <div class="text-h5 font-weight-bold mb-3 mt-5">定義問題與策略</div>
            <p class="text-subtitle-1 text-medium-emphasis mb-3">
                HOPE Art Studio 網站過去多是直接以畫作來做為整體元素用以呈現網站的視覺，現今為展現品牌的核心理念，採用黑白為主色調，展示前衛、 古典、瘋狂的嶄新視覺。</p>
            <figure class="my-5">
                <v-responsive aspect-ratio="4/3" class="rounded-xl overflow-hidden">
                    <img src="/hopeart/strategy.jpg" alt="策略三角示意" style="width:100%;height:100%;object-fit:cover" />
        ...
        <!-- 色彩與字體（色票可複製） -->
        <section id="brand" class="mb-10 pt-10">
            <div class="text-h5 font-weight-bold mb-3">色彩與字體</div>
            <p class="text-subtitle-1 text-medium-emphasis mb-3">
                主要色彩為白底黑字，目的是以簡單、乾淨的畫面來襯托藝術創作。在需要營造寧靜、神秘氛圍時使用黑底白字。</p>
            <p class="text-subtitle-1 text-medium-emphasis mb-3 pt-1">小範圍點綴使用黃色，用於營造強烈的品牌印象。暖灰則是用於背景有需要層次分隔時，以輔助白色。
            </p>
            <div rounded="xl" elevation="1">
                <img src="/hopeart/color.jpg" alt="色彩" style="width:100%;height:100%;object-fit:cover" />
                <div class="ml-6">
                    <div class="pb-3 text-h6">色票</div>
                    ...
                    <div class="text-caption text-medium-emphasis mt-2">點色票可複製</div>
                    <v-alert v-if="copied" type="success" variant="tonal" class="mt-3">{{ copied }} 已複製</v-alert>
                </div>
            </div>
            <p class="text-subtitle-1 text-medium-emphasis mb-3 pt-10">
                中文大標使用流源明體，其富有溫度與文藝氣息，用於營造氛圍感及打造畫室形象。內文使用 Noto Sans，其簡潔俐落，可清楚傳達內容</p>
            <p class="text-subtitle-1 text-medium-emphasis mb-3 pt-1">
                英文大標使用 Georgia，其大膽、華麗，用於營造氛圍感及打造畫室形象。內文使用Helvetica，其簡潔俐落，可清楚傳達內容
            </p>
            <div class="ml-6">
                <div rounded="xl" elevation="1" class="mt-5">
                    <v-row dense class="mb-6">
                        <!-- 左圖 -->
                        <v-col cols="12" md="6">
                            <v-responsive aspect-ratio="4/3" class="rounded-xl overflow-hidden">
                                <img src="/hopeart/font-CN-800.jpg"
                                    srcset="/hopeart/font-CN-400.jpg 400w, /hopeart/font-CN-800.jpg 800w, /hopeart/font-CN-1200.jpg 1200w"
                                    sizes="(min-width: 960px) 50vw, 100vw" alt="左圖" loading="lazy" decoding="async"
                        ...
                        <v-col cols="12" md="6">
                            <v-responsive aspect-ratio="4/3" class="rounded-xl overflow-hidden">
                                <img src="/hopeart/font-EN-800.jpg"
                                    srcset="/hopeart/font-EN-400.jpg 400w, /hopeart/font-EN-800.jpg 800w, /hopeart/font-EN-1200.jpg 1200w"
                                    sizes="(min-width: 960px) 50vw, 100vw" alt="右圖" loading="lazy" decoding="async"
                                    style="width:100%;height:100%;object-fit:cover;object-position:center" />
                            </v-responsive>
                        </v-col>
                    </v-row>
...
/* 熱點資料 */
const strategySpots = [
    { x: 55, y: 17, title: '提高品牌識別', text: '以核心理念為出發，重建視覺元素並強化一致性。' },
    { x: 68, y: 55, title: '導流策略', text: '導向月刊與藝術家專區，增加停留與轉換。' },
