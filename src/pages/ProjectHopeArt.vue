<template>
    <v-container>
      ...
      <v-sheet class="sticky-nav" elevation="1" rounded="xl">
        <div class="d-flex align-center flex-wrap ga-2">
          <v-chip
            v-for="s in sections"
            :key="s.id"
            :color="hash === '#' + s.id ? 'primary' : undefined"
            variant="tonal"
            :ripple="false"
            @click="scrollTo(s.id)"
          >
            ...
            <v-card rounded="xl" elevation="1">
              <v-card-text class="text-body-2">
                ...
                <div class="d-flex justify-space-between">
                  <span>網址</span>
                  <a class="text-primary" href="https://hopeart.com.tw/" target="_blank" rel="noopener">hopeart.com.tw</a>
                </div>
              </v-card-text>
            </v-card>
          </v-col>
          ...
          <v-col cols="12" md="6">
            <v-card rounded="xl" elevation="1">
              ...
              <v-card-text>
                ...
                <div class="text-caption text-medium-emphasis mt-2">點色票可複製 HEX</div>
      ...
      <section id="examples" class="mb-10">
        ...
        <v-row dense>
          <v-col cols="12" md="6">
            <v-img
              src="/hopeart/hope.jpg" height="300" cover class="rounded-lg"
  ...
  /* 色票 */
  const colors = [{ hex: '#000000' }, { hex: '#FFFFFF' }, { hex: '#BFED21' }, { hex: '#2F2F30' }]
  const copied = ref('')
  ...
  .font-sample { padding: 10px 0 }
  .font-sample.noto    { font-family: 'Noto Sans', system-ui, -apple-system, sans-serif; }
  .font-sample.georgia { font-family: Georgia, 'Times New Roman', serif; letter-spacing: .5px; }
  </style>
